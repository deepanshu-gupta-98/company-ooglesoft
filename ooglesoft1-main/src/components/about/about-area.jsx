...
const contents = {
  ...
  right_text_1:"Ooglesoft builds digital products that let people do things differently. Share your challenge with our team, and we’ll work with you to deliver a revolutionary digital product. Our clients have changed the way people do banking, listen to music.",
  right_text_2:"learn languages, Their products have been featured in TechCrunch, Business Insider, and Product Hunt.",
  client_icon:'/assets/img/about/testi-7.png',
  client_name:'Veer singh',
  client_title:'CEO & Founder',
  desc:"Wow. What a great experience with this company. Ooglesoft is a very talented digital agnecy. yesterday.",
