      ...
      <div className="tp-offcanvas-area">
        <div className={`tpoffcanvas ${isOpen ? 'opened' : ''}`}>
          <div className="tpoffcanvas__logo">
            <Link href="/">
              <a>
                <img src="/assets/img/logo/logo-foot.png" alt="" />
              </a>
            </Link>
          </div>
          ...
          <div className="tpoffcanvas__contact">
            ...
            <ul>
              <li>
                <i className="fas fa-star"></i> <a href="https://goo.gl/maps/abHegV4AoiJA6Syd8" rel="noreferrer" target="_blank">52/210, Padmani VT Rd, Ward 27, Mansarovar Sector 5, Mansarovar, Jaipur, Rajasthan 302020</a>
              </li>
              <li><i className="fas fa-star"></i><a href="tel:8180012345678">+91 978 462 6443 </a></li>
              <li><i className="fas fa-star"></i><a href="mailto:oglesoft@gmail.com">info@ooglesoft@gmail.com</a></li>
            </ul>
          </div>
