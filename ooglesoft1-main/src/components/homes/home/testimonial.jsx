...
const testimonial_data = [
  {
    id: 1,
    user: '/assets/img/testimonial/testi-1.jpg',
    name: 'Darrell Steward',
    title: 'Founder of (Rirax)',
    ratings: [1, 2, 3, 4, 5],
    desc: 'Ooglesoft was very diligent, polite and extremely customer oriented. I think Monika will go far with that attitude and ...he is such a honest, decent and reliable.'
  },
  {
    id: 2,
