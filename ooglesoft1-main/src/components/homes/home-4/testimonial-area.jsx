...
const testimonial_contents = {
  ...
  testimonial_data: [
    {
      id: 1,
      brand_img: '/assets/img/testimonial/testi-brands-1.jpg',
      ratings: [1, 2, 3, 4, 5],
      desc: 'Wow. What a great experience with this company. Mr.veer singh is a very talented . yesterday I got his first Email that was amazing... experience with him',
      img: '/assets/img/testimonial/testi-4.5.png',
      name: 'Deepanshu',
      title: 'P. Desiger of (trip-hike)'
    },
    {
      id: 2,
      brand_img: '/assets/img/testimonial/testi-brands-2.jpg',
      ratings: [1, 2, 3, 4, 5],
      desc: "Excellent web Design. He literally transformed my App into a wonderful piece of art. He's got awesome web design skills. - Hardworking Dedicated Great Communication Skills",
      img: '/assets/img/testimonial/testi-4.5.png',
      name: 'Saurabh',
      title: 'Ux Designer of (celebso)'
    },
    {
      id: 3,
      brand_img: '/assets/img/testimonial/testi-brands-3.jpg',
      ratings: [1, 2, 3, 4, 5],
      desc: "Absolutely amazing. we can't believe how incredible this turned out. veer singh is a true professional. he is such a honest, decent and reliable. and he have greate experience.",
      img: '/assets/img/testimonial/testi-4.5.png',
      name: 'Rohan',
      title: 'CEO of (Mridul & Rohan)'
    },
