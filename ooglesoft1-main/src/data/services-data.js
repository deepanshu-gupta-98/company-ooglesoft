...
const services_data = [
  {
    ...
    text_1:'At Ooglesoft we specialize in designing, building, shipping and scaling beautiful, usable products with blazing-fast',
    text_2:'At Ooglesoft we specialize in designing, building, shipping and scaling...',
    home:true,
    service_p_2:true,
  },
  {
  ...
  // home four
  {
    ...
    border_effect:'',
    text_1:'We enhance customer experiences for success',
    home_4:true,
    service_p:true,
  },
  {
    ...
    duration:'.5s',
    delay:'.7s',
    img:'/assets/img/service/digital1.jpg',
    title:'Digital Marketing',
    border_effect:'sv-border-effect-1',
    text_1:'Through SEO, content,email marketing and more',
    home_4:true,
    service_p:true,
  },
  {
    ...
    text_1:' a collaboration between popular social-media users and brands to promote brands products or services.',
    home_4:true,
    service_p:true,
  },
  {
  ...
  },
  {
    ...
    text_1:'we can provide all around the world.</p>',
    home_4:true,
    service_p:true,
  },
  {
    ...
    text_1:'We have a best team for your shopping websites.',
    home_4:true,
    service_p:true,
  },
  {
  ...
  },
  {
   ...
   // home six
   {
    ...
    img:'/assets/img/service/service-1.png',
    icon:<Bulb/>,
    title:"Ooglesoft business solution",
    text_1:'At Ooglesoft we specialize in designing, building, shipping and scaling beautiful, usable products with blazing-fast',
    duration:'.3s',
    delay:'.5s',
    home_6:true,
