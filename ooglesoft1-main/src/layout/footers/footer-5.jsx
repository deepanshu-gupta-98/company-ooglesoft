...
const footer_contents = {
  ...
  title: 'Discover our Ooglesoft inner system',
  sm_text: 'At Ooglesoft we specialize in designing, building, shipping and scaling beautiful, usable products with blazing-fast efficiency',
  btn_text: "Contact us",
  copy_right: <>© {new Date().getFullYear()} Personal Portfolio , All Right Receved.</>,
  logo: '/assets/img/logo/logo-foot.png',
}
